...
pub enum Action {
    ...
    FocusColumnOrMonitorUp,
    FocusColumnOrMonitorDown,
...
impl From<niri_ipc::Action> for Action {
    fn from(value: niri_ipc::Action) -> Self {
        match value {
            ...
            niri_ipc::Action::FocusColumnOrMonitorUp => Self::FocusColumnOrMonitorUp,
            niri_ipc::Action::FocusColumnOrMonitorDown => Self::FocusColumnOrMonitorDown,
