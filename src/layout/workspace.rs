...
impl<W: LayoutElement> Workspace<W> {
    ...
    pub fn add_floating_tile(&mut self, tile: Tile<W>, pos: Point<f64, Logical>, activate: bool) {
        self.enter_output_for_window(tile.window());
    ...
    pub fn add_tile_right_of(
        ...
        if self.floating.has_window(right_of) {
    ...
    pub fn remove_active_column(&mut self) -> Option<Column<W>> {
        let from_floating = self.floating_is_active;
        if self.floating_is_active {
            // TODO: convert active floating window into column.
            return None;
        }
    ...
    pub fn consume_or_expel_window_left(&mut self, window: Option<&W::Id>) {
        if self.floating_is_active || window.is_some_and(|id| self.floating.has_window(id)) {
            return;
        }
    ...
    pub fn reset_window_height(&mut self, window: Option<&W::Id>) {
        if window.is_some_and(|id| self.floating.has_window(id)) {
            // TODO
            return;
        }
    ...
    pub fn toggle_window_floating(&mut self, id: Option<&W::Id>) {
        ...
        if self.floating.has_window(&id) {
            ...
            // TODO: move this in a better way. If partially outside the working area, move inside.
            let pos = render_pos + Point::from((50., 50.));
            self.floating.add_tile(removed.tile, pos, target_is_active);
            if target_is_active {
                self.floating_is_active = true;
            }
        }
    ...
    pub fn render_elements<R: NiriRenderer>(
        ...
        let floating = self.floating.render_elements(renderer, scale, target);
    ...
    pub fn start_close_animation_for_tile(
        ...
        // TODO: when floating happens, put this on the floating layer. It's used for interactive
