...
impl<W: LayoutElement> Workspace<W> {
    ...
    pub fn remove_window(&mut self, window: &W::Id, transaction: Transaction) -> W {
        self.remove_window_with_col_info(window, transaction).3
    }
    ...
    pub fn remove_window_with_col_info(
        ...
        let (_, render_pos) = self
            ...
            .unwrap();
        let window = self
            .remove_tile_by_idx(column_idx, window_idx, transaction, None)
            .into_window();
...
impl<W: LayoutElement> Column<W> {
    ...
    fn add_tile_at(&mut self, pos: usize, tile: Tile<W>, animate: bool) {
        ...
        self.data
            .insert(pos, TileData::new(&tile, WindowHeight::auto_1()));
