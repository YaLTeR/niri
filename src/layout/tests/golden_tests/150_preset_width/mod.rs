...
fn preset_cycling_rightmost_column_with_overflow_1_ops() -> Vec<Op> {
    vec![Op::SwitchPresetColumnWidth, Op::Communicate(3), Op::CompleteAnimations,]
}
...
fn preset_width_index_cycles_backward_1_ops() -> Vec<Op> {
    vec![Op::SwitchPresetColumnWidthBack, Op::Communicate(1), Op::CompleteAnimations,]
}
fn preset_width_index_cycles_backward_2_ops() -> Vec<Op> {
    vec![Op::SwitchPresetColumnWidthBack, Op::Communicate(1), Op::CompleteAnimations,]
}
fn preset_width_index_cycles_correctly_1_ops() -> Vec<Op> {
    vec![Op::SwitchPresetColumnWidth, Op::Communicate(1), Op::CompleteAnimations,]
}
...
fn preset_cycling_rightmost_column_with_overflow_1() {
    ...
    check_ops_on_layout(
        &mut layout,
        preset_cycling_rightmost_column_with_overflow_1_ops(),
    );
...
fn preset_cycling_rightmost_column_with_overflow_2() {
    ...
    check_ops_on_layout(
        &mut layout,
        preset_cycling_rightmost_column_with_overflow_2_ops(),
    );
...
fn preset_cycling_rightmost_column_with_overflow_3() {
    ...
    check_ops_on_layout(
        &mut layout,
        preset_cycling_rightmost_column_with_overflow_3_ops(),
    );
...
fn preset_cycling_rightmost_column_with_overflow_4() {
    ...
    check_ops_on_layout(
        &mut layout,
        preset_cycling_rightmost_column_with_overflow_4_ops(),
    );
