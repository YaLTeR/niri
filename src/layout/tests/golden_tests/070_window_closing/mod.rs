...
fn closing_first_of_three_fifths_preset_1_ops() -> Vec<Op> {
    vec![
        Op::FocusColumnLeft, Op::FocusColumnLeft, Op::CloseWindow(1), Op::Communicate(2),
...
fn closing_last_of_three_fifths_preset_ops() -> Vec<Op> {
    vec![
        Op::CloseWindow(3), Op::Communicate(1), Op::Communicate(2),
...
fn closing_leftmost_column_with_overflow_1_ops() -> Vec<Op> {
    vec![
        Op::CloseWindow(1), Op::Communicate(2), Op::Communicate(3),
        Op::CompleteAnimations,
    ]
}
...
fn closing_middle_column_with_overflow_1_ops() -> Vec<Op> {
    vec![
        Op::CloseWindow(2), Op::Communicate(1), Op::Communicate(3),
        Op::CompleteAnimations,
    ]
}
...
fn closing_middle_of_three_fifths_preset_ops() -> Vec<Op> {
    vec![
        Op::FocusColumnLeft, Op::CloseWindow(2), Op::Communicate(1), Op::Communicate(3),
        Op::CompleteAnimations,
    ]
}
