...
fn column_x_positions_mixed_widths() {
    ...
    column[1]: x=200.0 width=Proportion(0.5) active_tile=0
      tile[0]: x=200.0 y=0.0 w=640 h=720 window_id=2
    column[2] [ACTIVE]: x=840.0 width=Fixed(300.0) active_tile=0
      tile[0] [ACTIVE]: x=840.0 y=0.0 w=300 h=720 window_id=3
    ");
}
