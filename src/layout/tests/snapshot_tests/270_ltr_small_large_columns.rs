...
fn very_small_view_width() {
    ...
    column[0]: x=0.0 width=Fixed(50.0) active_tile=0
      tile[0]: x=0.0 y=0.0 w=50 h=720 window_id=1
    column[1]: x=50.0 width=Fixed(50.0) active_tile=0
      tile[0]: x=50.0 y=0.0 w=50 h=720 window_id=2
    column[2] [ACTIVE]: x=100.0 width=Fixed(50.0) active_tile=0
      tile[0] [ACTIVE]: x=100.0 y=0.0 w=50 h=720 window_id=3
    ");
}
...
fn single_very_wide_column() {
    ...
    active_tile_viewport_y=0.0
    column[0] [ACTIVE]: x=0.0 width=Fixed(2000.0) active_tile=0
      tile[0] [ACTIVE]: x=0.0 y=0.0 w=2000 h=720 window_id=1
    ");
}
