...
fn gaps_struts_and_centering_combined() {
    ...
    view_pos=840.0
    active_column=3
    active_column_x=1224.0
    active_tile_viewport_x=384.0
    active_tile_viewport_y=0.0
    column[0]: x=0.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0]: x=0.0 y=0.0 w=392 h=668 window_id=1
    column[1]: x=408.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0]: x=408.0 y=0.0 w=392 h=668 window_id=2
    column[2]: x=816.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0]: x=816.0 y=0.0 w=392 h=668 window_id=3
    column[3] [ACTIVE]: x=1224.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0] [ACTIVE]: x=1224.0 y=0.0 w=392 h=668 window_id=4
    ");
}
...
fn preset_widths_with_gaps() {
    ...
    view_pos=-20.0
    active_column=1
    active_column_x=120.0
    active_tile_viewport_x=140.0
    active_tile_viewport_y=0.0
    column[0]: x=0.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=0.0 y=0.0 w=100 h=680 window_id=1
    column[1] [ACTIVE]: x=120.0 width=Fixed(100.0) active_tile=0
      tile[0] [ACTIVE]: x=120.0 y=0.0 w=100 h=680 window_id=2
    ");
    ...
    column[0]: x=0.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=0.0 y=0.0 w=100 h=680 window_id=1
    column[1] [ACTIVE]: x=120.0 width=Proportion(0.33333333333333326) active_tile=0
      tile[0] [ACTIVE]: x=120.0 y=0.0 w=399 h=680 window_id=2
    ");
    ...
    column[0]: x=0.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=0.0 y=0.0 w=100 h=680 window_id=1
    column[1] [ACTIVE]: x=120.0 width=Proportion(0.5) active_tile=0
      tile[0] [ACTIVE]: x=120.0 y=0.0 w=610 h=680 window_id=2
    ");
}
