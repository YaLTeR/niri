...
fn preset_width_index_cycles_correctly() {
    ...
    active_tile_viewport_x=0.0
    active_tile_viewport_y=0.0
    column[0] [ACTIVE]: x=0.0 width=Proportion(0.6666666666666665) active_tile=0
...
fn preset_cycling_two_fifths_to_four_fifths() {
    ...
    column[1] [ACTIVE]: x=100.0 width=Proportion(0.6) active_tile=0
      tile[0] [ACTIVE]: x=100.0 y=0.0 w=768 h=720 window_id=2
    ");
    ...
    column[0]: x=0.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=0.0 y=0.0 w=100 h=720 window_id=1
    column[1] [ACTIVE]: x=100.0 width=Proportion(0.8) active_tile=0
      tile[0] [ACTIVE]: x=100.0 y=0.0 w=1024 h=720 window_id=2
    ");
}
...
fn preset_cycling_middle_column_with_overflow() {
    ...
    column[1] [ACTIVE]: x=100.0 width=Proportion(0.4) active_tile=0
      tile[0] [ACTIVE]: x=100.0 y=0.0 w=512 h=720 window_id=2
    column[2]: x=612.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=612.0 y=0.0 w=100 h=720 window_id=3
    ");
    ...
    column[1] [ACTIVE]: x=100.0 width=Proportion(0.6) active_tile=0
      tile[0] [ACTIVE]: x=100.0 y=0.0 w=768 h=720 window_id=2
    column[2]: x=868.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=868.0 y=0.0 w=100 h=720 window_id=3
    ");
    ...
    column[1] [ACTIVE]: x=100.0 width=Proportion(0.8) active_tile=0
      tile[0] [ACTIVE]: x=100.0 y=0.0 w=1024 h=720 window_id=2
    column[2]: x=1124.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=1124.0 y=0.0 w=100 h=720 window_id=3
    ");
}
...
fn preset_cycling_rightmost_column_with_overflow() {
    ...
    column[1]: x=100.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=100.0 y=0.0 w=100 h=720 window_id=2
    column[2] [ACTIVE]: x=200.0 width=Proportion(0.4) active_tile=0
      tile[0] [ACTIVE]: x=200.0 y=0.0 w=512 h=720 window_id=3
    ");
    ...
    column[1]: x=100.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=100.0 y=0.0 w=100 h=720 window_id=2
    column[2] [ACTIVE]: x=200.0 width=Proportion(0.6) active_tile=0
      tile[0] [ACTIVE]: x=200.0 y=0.0 w=768 h=720 window_id=3
    ");
    ...
    column[1]: x=100.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=100.0 y=0.0 w=100 h=720 window_id=2
    column[2] [ACTIVE]: x=200.0 width=Proportion(0.8) active_tile=0
      tile[0] [ACTIVE]: x=200.0 y=0.0 w=1024 h=720 window_id=3
    ");
}
