...
// ============================================================================
// SPAWNING - Multiple Columns (1/3 width)
// ============================================================================
...
fn spawn_one_half_tiles() {
    ...
    view_pos=640.0
    active_column=2
    active_column_x=1280.0
    active_tile_viewport_x=640.0
    active_tile_viewport_y=0.0
    column[0]: x=0.0 width=Proportion(0.5) active_tile=0
      tile[0]: x=0.0 y=0.0 w=640 h=720 window_id=1
    column[1]: x=640.0 width=Proportion(0.5) active_tile=0
      tile[0]: x=640.0 y=0.0 w=640 h=720 window_id=2
    column[2] [ACTIVE]: x=1280.0 width=Proportion(0.5) active_tile=0
      tile[0] [ACTIVE]: x=1280.0 y=0.0 w=640 h=720 window_id=3
    ");
}
