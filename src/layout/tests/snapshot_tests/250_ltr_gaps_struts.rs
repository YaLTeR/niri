...
fn very_large_gaps() {
    ...
    view_pos=93.0
    active_column=1
    active_column_x=393.0
    active_tile_viewport_x=300.0
    active_tile_viewport_y=0.0
    column[0]: x=0.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0]: x=0.0 y=0.0 w=293 h=520 window_id=1
    column[1] [ACTIVE]: x=393.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0] [ACTIVE]: x=393.0 y=0.0 w=293 h=520 window_id=2
    ");
}
...
fn very_large_struts() {
    ...
    column[0] [ACTIVE]: x=0.0 width=Proportion(0.5) active_tile=0
      tile[0] [ACTIVE]: x=0.0 y=0.0 w=440 h=520 window_id=1
    ");
}
