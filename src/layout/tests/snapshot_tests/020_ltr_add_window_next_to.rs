...
fn spawn_window_between_two_columns() {
    ...
    column[2] [ACTIVE]: x=200.0 width=Fixed(100.0) active_tile=0
      tile[0] [ACTIVE]: x=200.0 y=0.0 w=100 h=720 window_id=2
    ");
}
...
fn spawn_window_between_three_columns() {
    ...
    column[2]: x=200.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=200.0 y=0.0 w=100 h=720 window_id=4
    column[3] [ACTIVE]: x=300.0 width=Fixed(100.0) active_tile=0
      tile[0] [ACTIVE]: x=300.0 y=0.0 w=100 h=720 window_id=3
    ");
}
...
fn spawn_window_between_with_mixed_sizes() {
    ...
    column[2]: x=526.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=526.0 y=0.0 w=100 h=720 window_id=4
    column[3] [ACTIVE]: x=626.0 width=Proportion(0.5) active_tile=0
      tile[0] [ACTIVE]: x=626.0 y=0.0 w=640 h=720 window_id=3
    ");
}
...
fn spawn_window_between_with_gaps() {
    ...
    view_pos=100.0
    active_column=3
    active_column_x=348.0
    active_tile_viewport_x=248.0
    active_tile_viewport_y=0.0
    column[0]: x=0.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=0.0 y=0.0 w=100 h=688 window_id=1
    column[1]: x=116.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=116.0 y=0.0 w=100 h=688 window_id=4
    column[2]: x=232.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=232.0 y=0.0 w=100 h=688 window_id=2
    column[3] [ACTIVE]: x=348.0 width=Fixed(100.0) active_tile=0
      tile[0] [ACTIVE]: x=348.0 y=0.0 w=100 h=688 window_id=3
    ");
}
