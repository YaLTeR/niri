...
fn expel_from_column_with_tiles() {
    ...
    column[0]: x=0.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0]: x=0.0 y=0.0 w=426 h=720 window_id=1
    column[1]: x=426.0 width=Fixed(100.0) active_tile=0
      tile[0]: x=426.0 y=0.0 w=100 h=720 window_id=2
    column[2] [ACTIVE]: x=526.0 width=Fixed(100.0) active_tile=0
      tile[0] [ACTIVE]: x=526.0 y=0.0 w=100 h=720 window_id=3
    ");
}
