...
fn scale_factor_1_5() {
    ...
    view_pos=184.0
    active_column=1
    active_column_x=284.0
    active_tile_viewport_x=100.0
    active_tile_viewport_y=0.0
    column[0]: x=0.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0]: x=0.0 y=0.0 w=284 h=480 window_id=1
    column[1] [ACTIVE]: x=284.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0] [ACTIVE]: x=284.0 y=0.0 w=284 h=480 window_id=2
    ");
}
...
fn scale_factor_2_0() {
    ...
    view_pos=220.0
    active_column=1
    active_column_x=320.0
    active_tile_viewport_x=100.0
    active_tile_viewport_y=0.0
    column[0]: x=0.0 width=Proportion(0.5) active_tile=0
      tile[0]: x=0.0 y=0.0 w=320 h=360 window_id=1
    column[1] [ACTIVE]: x=320.0 width=Proportion(0.5) active_tile=0
      tile[0] [ACTIVE]: x=320.0 y=0.0 w=320 h=360 window_id=2
    ");
}
...
fn scale_factor_with_gaps() {
    ...
    view_pos=147.3
    active_column=1
    active_column_x=279.3
    active_tile_viewport_x=132.0
    active_tile_viewport_y=0.0
    column[0]: x=0.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0]: x=0.0 y=0.0 w=263 h=448 window_id=1
    column[1] [ACTIVE]: x=279.3 width=Proportion(0.33333333333333337) active_tile=0
      tile[0] [ACTIVE]: x=279.3 y=0.0 w=263 h=448 window_id=2
    ");
}
