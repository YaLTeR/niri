...
fn resize_with_multiple_tiles_open() {
    ...
    column[1] [ACTIVE]: x=426.0 width=Proportion(0.5) active_tile=0
      tile[0] [ACTIVE]: x=426.0 y=0.0 w=640 h=720 window_id=2
    column[2]: x=1066.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0]: x=1066.0 y=0.0 w=426 h=720 window_id=3
    ");
}
...
fn resize_while_scrolled_overflow() {
    ...
    column[2]: x=1066.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0]: x=1066.0 y=0.0 w=426 h=720 window_id=3
    column[3]: x=1492.0 width=Proportion(0.33333333333333337) active_tile=0
      tile[0]: x=1492.0 y=0.0 w=426 h=720 window_id=4
    ");
}
