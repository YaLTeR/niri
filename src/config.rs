...
pub enum Action {
    ...
    FocusColumnLeft,
    FocusColumnRight,
    FocusWindowDown(#[knuffel(argument, default = false)] bool),
    FocusWindowUp(#[knuffel(argument, default = false)] bool),
    MoveColumnLeft,
    MoveColumnRight,
    MoveWindowDown(#[knuffel(argument, default = false)] bool),
    MoveWindowUp(#[knuffel(argument, default = false)] bool),
