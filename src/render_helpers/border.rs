    ...
    pub fn empty() -> Self {
        ...
        Self {
            ...
            params: Parameters {
                ...
                color_from2: Default::default(),
                color_to2: Default::default(),
                gradient_lerp: -1.,
                angle: 0.,
    ...
    fn update_inner(&mut self) {
        ...
        self.inner.update(
            ...
            Rc::new([
                ...
                Uniform::new("color_from2", color_from2.to_array_unpremul()),
                Uniform::new("color_to2", color_to2.to_array_unpremul()),
                Uniform::new("gradient_lerp", gradient_lerp),
