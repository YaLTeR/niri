...
impl InputBackend for RdInputBackend {
    ...
    // Using same type, caller must use the correct enum variant
    // TODO: impl!!
    //type TouchDownEvent = RdEventAdapter<RdTouchEvent>;
    //type TouchUpEvent = RdEventAdapter<RdTouchEvent>;
    //type TouchMotionEvent = RdEventAdapter<RdTouchEvent>;
...
pub struct RdPointerMotionAbsoluteEvent {
    /// X position ranging from 0 to 1
    pub x: f64,
    /// Y position ranging from 0 to 1
    pub y: f64,
}

impl AbsolutePositionEvent<RdInputBackend>
    for RdEventAdapter<RdPointerMotionAbsoluteEvent>
{
    fn x(&self) -> f64 {
        self.inner.x
    }
    ...
    fn x_transformed(&self, width: i32) -> f64 {
        (self.inner.x as i64 * width as i64) as f64
    }

    fn y_transformed(&self, height: i32) -> f64 {
        (self.inner.y as i64 * height as i64) as f64
    }
}

impl PointerMotionAbsoluteEvent<RdInputBackend>
    for RdEventAdapter<RdPointerMotionAbsoluteEvent>
{
}
