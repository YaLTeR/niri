//! Input backend for emulated input events received directly via `org.gnome.Mutter.RemoteDesktop` without EI.
...
impl AbsolutePositionEvent<RdInputBackend> for RdEventAdapter<RdPointerMotionAbsoluteEvent> {
    fn x(&self) -> f64 {
        self.inner.0.pos.x / self.inner.0.global_extent.w
    }

    fn y(&self) -> f64 {
        self.inner.0.pos.y / self.inner.0.global_extent.h
    }

    fn x_transformed(&self, width: i32) -> f64 {
        self.inner.0.pos.x / self.inner.0.global_extent.w * width as f64
    }

    fn y_transformed(&self, height: i32) -> f64 {
        self.inner.0.pos.y / self.inner.0.global_extent.h * height as f64
    }
}
...
impl AbsolutePositionEvent<RdInputBackend> for RdEventAdapter<RdTouchEvent<RdAbsolutePosition>> {
    fn x(&self) -> f64 {
        self.inner.extra.pos.x / self.inner.extra.global_extent.w
    }

    fn y(&self) -> f64 {
        self.inner.extra.pos.y / self.inner.extra.global_extent.h
    }

    fn x_transformed(&self, width: i32) -> f64 {
        self.inner.extra.pos.x / self.inner.extra.global_extent.w * width as f64
    }

    fn y_transformed(&self, height: i32) -> f64 {
        self.inner.extra.pos.y / self.inner.extra.global_extent.h * height as f64
    }
}
